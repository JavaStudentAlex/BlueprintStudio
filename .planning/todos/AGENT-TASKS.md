...
|----|-------|--------|------|-------|-------|------------|
| flowdraft-golden-demo-frontend | 8 | todo | medium | Add frontend golden demo workflow | `frontend/src/**`, `frontend/tests/**`, `.planning/**` | `Load demo` works without upload/API keys/network; rooms, valuation, and compliance views render deterministic fixture data; frontend tests cover the path. |
